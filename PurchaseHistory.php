...
$sql = "SELECT * FROM giftcard  WHERE CustomerID='$_SESSION[CustomerID]'";;
      ...
      <table class="table">
        <thead class="table__thead">
          <tr class="table__head">
            ...
            <th class="table__th">GiftID</th>
            <th class="table__th">Sender</th>
            <th class="table__th">ReceipientEmail</th>
            <th class="table__th">RecipientName</th>
        ...
        <tbody class="table__tbody">
          <tr class="table__tr">
            <td class="table__td table__mobile-title">
              <span><?php echo ($row['Gift_ID']) ; ?></span>
            </td>
            <td class="table__td table__mobile-title">
              <span><?php echo ($row['Sender']); ?></span>
            </td>
            <td class="table__td table__mobile-title">
              <span><?php echo ($row['Receipient_Email']); ?></span>
            </td>
            <td class="table__td table__mobile-title">
              <span><?php echo ($row['Recipient_Name']); ?></span>
            </td>
            <td class="table__td table__mobile-title">
